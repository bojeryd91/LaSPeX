...
\usepackage{blindtext, mwe} % Just for test
...
\begin{framsida}
    Denna ligger konstigt till vänster när vi använder option \textbf{with-crop}. Varför? \blindtext
\end{framsida}
...
\begin{figure}
    \centeredContent{%
    \framebox{\includegraphics[width=0.7\pagetextWidth]{example-image-a}}
    \medskip
    \textit{Hejsan detta är en bildtext.}}
\end{figure}
