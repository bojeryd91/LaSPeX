...
\scenanvisning{Anchesenpaaton kommer in med Amenhoteps kläder och avbryter A\-men\-ho\-teps replik.}
...
\scenanvisning
\c kommer in och stöter en marskalksstav i golvet.
Entr\'e för \pt och \pa.

\c      Hennes Heliga Höghet, krokodiläggens förmyndare
        och Iris synska ögontjänare!

\scenanvisning
\c stöter staven i golvet igen.

\forts      Hans Höge Helighet, frugornas herre, Hor(h)us tillskyndare,
        och prinsessan \anc-s personlige tränare!

\scenanvisning
\t råkar stå bredvid \c. Vid en ytterligare stöt petar han till staven så \c stöter den i foten, vilket gör ont.
...
\scenanvisning
\t masar sig ut. \pt och \pa öppnar audiensen med en kort egyptisk ceremoni med frukter. Orkestern spelar "Montague och Capulet" ur Romeo och Julia av Prokofjev.

%\musik{De gudsfruktiga}{\pt{}, \pa{} \& dansare}{Montague och Capulet ur Romeo och Julia}{Prokofjev}{}
%\musik{De gudsfruktiga}{\pt, \pa, dansare}{Montague och Capulet ur Romeo och Julia}{Prokofjev}{\pt och \pa genomför en procession med frukter.}

\scenanvisning
Efter ceremonins slut drar sig Prästen och Prästinnan framåt scenkanten tillsammans med Anchesenpaaton. I bakgrunden tar Amenhotep, assisterad av Nefertite, emot dagens första besök. Statister kommer in bakifrån och avhandlar sina ärenden på pantomim.
...
\anc    \till{\pa} Ka'nte ni berätta lite om de gamla egyptiernas visdom?
...
\pa     Jungfrun {\it e' klips}k och behöver bli stjärnbildad.
        ...
        \till{\anc} Du kan stella dig och plugga i ett hörn!
...
\pa     Att du Våg-ar, din Stenbock! Är du helt förvildad?
        \till{\pt} Det kan börja gå rykten i omlopp!
...
\forts Då kan vi utvärdera min modell för slavisk optimering.
...
\scenanvisning
Två slavar kommer in med en vit skärm. En projektor går igång. En teckning av gamla tempel projiceras.
...
\scenanvisning
\pt pekar på kören, men \pa avbryter och pekar på offerborden.
