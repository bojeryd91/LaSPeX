% Här väljs med eller utan kommentarer: 
% "med-kommentarer" har allt.
% "utan-kommentarer" har endast repliker, nummer, in- och utgångar.

\documentclass[utan-teknik,utan-kommentarer,swedish,book]{laspex}
%\documentclass[med-teknik,utan-kommentarer]{laspex}
%\documentclass[med-teknik,med-kommentarer,book]{laspex}
%\documentclass[med-teknik,med-kommentarer,book,swedish]{laspex}
...
\dud \mittbord{\kommentar{Ignorerar Bacon.} En skotsk drottning borde välkomnas med en \vits{skott-tår.} \kommentar{Håller upp en flaska whisky.}
...
\dud	Det förklarar \vits{änke}-biljetten, ers höghet   
...
\utgang{Vakten och bröderna Bacon ut vänster bak.}		
\ingang{Filip in höger bak.}
\utgang{Filip ut vänster bak.}
\ingang{Beaton, Fleming, Livingstone in höger bak.}
\utgang{Beaton, Fleming, Livingstone ut vänster bak.}
...
\musikbox{Maria har fängslats!}{Alla}{Maria ska fängslas! Vad kommer att hända med henne?  Har Elisabet överreagerat? Maria undrar hur hon hamnade här.}{I believe in a thing called love}{The Darkness}{}
